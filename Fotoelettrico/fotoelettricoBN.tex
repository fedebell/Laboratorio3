...
Si è montato il circuito in ?gura \ref{fig:circuito}. Nella scatola nera erano fissati il fotomoltiplicatore e la lampada a LED che serviva da sorgente luminosa. Durante l'esperienza, si sono montati i filtri nell'apposito supporto, avendo cura che fossero ortogonali al piano di appoggio della scatola e quindi al fascio luminoso.
...
\caption{Schema circuito dell'esperimento e di acquisizione dati.\label{fig:circuito}}
\end{figure}
...
\section{Elaborazione dati: stima potenziale di frenamento $V_0$}
Per trovare la relazione fra frequenza dei fotoni incidenti e il relativo potenziale di frenamento è necessario stimare dai dati quest'ultimo. Per fare ciò abbiamo usato due metodi.
\subsection{Metodo A}

\subsection{Metodo B}
Per ogni filtro si è stimato il relativo potenziale di frenamento $V_0$ corrispondente alla tensione per cui la corrente fotocatodica risulta compatibile con 0 entro l'incertezza $\delta I$.
...
\begin{equation}
I(V_0)=-til\bar{I}+\delta(I)\Rightarrow V_0=\bar{V}+\frac{1}{a}\ln\frac{\bar{I}}{\delta I}
\end{equation} 
