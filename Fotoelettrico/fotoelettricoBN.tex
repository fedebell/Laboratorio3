...
In effetti un andamento di tipo retta descrive molto meglio l'andamento di tali punti.
Ai fini dei fit ci è comunque sembrato sensato andare a considerare come corrente asintotica  il valor medio sui punti presi, e come incertezza la semidispersione da tale valore.
...
\hline
Colore & $\delta I$ (nA) & $V_{0}$(mV) & $\sigma V_0$ (mV)\\
\hline
Arancio & 0.02 & &\\
\hline
Giallo & 0.02 &  & \\
...
Una volta ottenuti i potenziali di azzeramento per le varie frequenze, si esegue un fit secondo la funzione modello $V_0=a*f + b$.
Secondo il modello, $a = h/e\simeq 4.1 \mbox{V}\cdot\mbox{s}*10*{-15}$.
...
Come valore del coefficiente angolare si è ottenuto $a = 3.8\pm 0.2 \mbox{V}\cdot{s}*10^{-15}$, in buon accordo con il valore atteso.
...
Come prima cosa si osserva che in realtà questa non è costante all'aumentare della tensione applicata all'apparato: in effetti si osserva dai dati un andamento decrescente (come si può osservare dai fit con rette eseguiti sui dati asintotici nei punti precedenti).
Per studiare l'andamento della corrente anodica in funzione delle frequenze si sono riportati in figura \ref{fig:correnteanodica} i valori estratti nei punti precedenti. Ci aspettiamo che esso dipenda principalmente dallo spettro di emissione della lampada utilizzata e dalle varie trasmittanze dei filtri.
