...
Misurare la costante di Bolzmann dal rumore termico (Johnson-Nyquist) di una resistenza a temperatura nota, grazie ad un amplificatore, un filtro passa-banda e un convertitore RMS.
...
I parametri riportati dal fit sono $V_0 = 80 \pm 3$mV e $R_t = 23 \pm 4 \mbox{k}\Omega$. La matrice di covarianza è:  $\Sigma_{ij} = \left( \begin{array}{cc}
12.1 & 11.8\\ 
11.8 & 13.9\\
