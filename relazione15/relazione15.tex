...
In realtà ai fini della misura del solo guadagno massimo è più efficace eseguire un fit alla sola retta sui dati a bassa frequenza, cioè dei primi sei punti con valori tutti uguali di $V_{out}$, ciò corrisponde a eseguire la semplice divisione $\frac{V_{out}}{V_{in}}$ con propagazione dell'errore, che fornisce $A_1 = 754 \pm 12$. %TODO hai effetivamente usato queto valore per i calcoli successivi? dovresti specificare meglio
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.8]{boltzmannEstesoFit.png}
