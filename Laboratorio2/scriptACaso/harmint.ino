...
interleaved. Vengono eseguite in successione 4 acquisizioni con un ritardo variabile
...
delay(1000); 
    ...
    delayMicroseconds(20); // Aspetta 20 us
    for(i=0;i<256;i++) 
      {
          t[i]=micros()-StartTime; 
          V[i]=analogRead(analogPin); 
...
for(i=0;i<2;i++) 
    ...
    delayMicroseconds(30); // Aspetta 30 us
    for(i=0;i<256;i++) 
      {
          t[i]=micros()-StartTime; 
          V[i]=analogRead(analogPin); 
