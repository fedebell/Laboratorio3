...
Directory='/home/federico/Documenti/Laboratorio2/RaccoltaDatiArduino-4/' # directory where the data file is stored
FileName=(Directory+'linearitaDigitalizzatore.txt') # filename (with directory)
