...
Directory='/home/federico/Documenti/Laboratorio2/RaccoltaDatiArduino-4/' # nome directory dove salvare i file dati
FileName=('/home/federico/Documenti/Laboratorio2/RaccoltaDatiArduino-4/'+'linearitaDigitalizzatore.txt') # nomina il file dati <<<< DA CAMBIARE SECONDO GUSTO 

outputFile = open(FileName, "w+" ) # apre file dati in scrittura

for j in range (1,nacqs+1):
        print('Apertura dello Stargate...\n') # scrive sulla console (terminale)
        ...
        print('Begin contact ',j, ' of ',nacqs) # scrive sulla console (terminale)
        ...
        print('Acquisition ',j,' complete otillaf\n') # scrive sulla console (terminale)
