...
ard.write(b'2')#intervallo (ritardo) in unita' di 10 ms <<<< questo si puo' cambiare (default messo a 20 ms)
 
print('Start!\n') # scrive sulla console (terminale)

FileName='/home/federico/Documenti/Laboratorio2/diodo/dati_arduino/dati.txt' # nomina il file dati <<<< DA CAMBIARE SECONDO GUSTO 
