...
ard.write(b'3')#intervallo (ritardo) in unita' di ms <<<< questo si puo' cambiare (default messo a 1 ms, max 9 ms)
 
print('Start!\n') # scrive sulla console (terminale)
FileName=('/home/federico/Documenti/Laboratorio2/transistor/dati7.txt') #nomina il file dati <<<< DA CAMBIARE SECONDO GUSTO 
