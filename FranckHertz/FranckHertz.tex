...
Di seguito sono riportati i grafici della corrente in unità arbitrarie. Tali grafici sono stati ottenuti dopo un processo di media operato con uno script Python per "ripulire" il i dati dagli effetti della digitalizzazione operata dall'acquisizione automatica dei dati con l'oscilloscopio.\\
